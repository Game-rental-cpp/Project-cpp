    ...
    : wxPanel(parent, id, pos, size)
{
    ...
    label = new wxStaticText(this, wxID_ANY, L"Witaj w wypożyczalni gier planszowych!", wxPoint(10, 10));
    label->SetForegroundColour(COLOR_LBL);
    label->SetFont(SetTheFont(15, true));

    label2 = new wxStaticText(this, wxID_ANY, L"Wybierz coś z listy i kliknij \"wypożycz\".", wxPoint(10, 40));
    ...
    sortOptions.Add(L"Liczba wypożyczeń");
    ...
    searchInput->SetHint(L"Wyszukaj grę...");
