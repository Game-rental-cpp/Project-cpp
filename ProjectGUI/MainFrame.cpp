...
{
    // Creating buttons
    goBackBtn = new wxButton(this, wxID_ANY, "WrÛÊ", wxDefaultPosition, wxSize(80, 40));
    ...
    // OdstÍp 10 pikseli od gÛrnej krawÍdzi
    sizer->AddSpacer(10);

    // wyúrodkowanie w poziomie
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Funkcja obs≥ugi zdarzenia po naciúniÍciu przycisku "WrÛÊ"
void MainFrame::OnGoBack(wxCommandEvent & event)
{
    ...
    // Przerysuj okno, aby zastosowaÊ zmiany widoku
    this->Layout();
}

// Funkcja obs≥ugi zdarzenia po naciúniÍciu przycisku "Zaloguj / zarejestruj"
...
// Funkcja obs≥ugi zdarzenia po naciúniÍciu przycisku "Moje konto"
